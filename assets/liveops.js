...
(function(){
  ...
  const FACTS={
    1:'중소기업제품 공공구매는 중소기업의 판로 확대와 성장 기반을 지원합니다.',2:'기술개발제품은 기술혁신 성과가 공공시장에 진입하도록 돕는 제도입니다.',3:'여성기업제품 제도는 여성기업의 공공시장 참여 기회를 확대합니다.',4:'장애인기업제품 구매는 장애인기업의 안정적 판로 확보를 지원합니다.',5:'중증장애인생산품 우선구매는 중증장애인의 직업재활과 고용을 지원합니다.',6:'사회적기업 제품 구매는 사회적 가치와 지역사회 문제 해결에 기여합니다.',7:'자활기업 제품 구매는 취약계층의 자립과 지속 가능한 일자리를 지원합니다.',8:'협동조합 제품 구매는 공동의 필요를 협력으로 해결하는 경제활동을 촉진합니다.',9:'마을기업 제품은 지역 자원을 활용해 지역경제와 공동체를 활성화합니다.',10:'창업기업제품 구매는 초기기업이 공공시장 실적을 쌓는 기회를 제공합니다.',11:'녹색제품 구매는 환경부하를 줄이고 친환경 소비와 생산을 촉진합니다.',12:'NEP는 국내에서 최초 개발된 신기술 제품의 공공시장 확산을 지원합니다.'
  };
