...
$('socialCameraBtn').onclick=()=>$('socialCameraFile').click();
$('socialGalleryBtn').onclick=()=>$('socialGalleryFile').click();
$('socialPreview').onclick=()=>$('socialGalleryFile').click();
$('socialCameraFile').onchange=()=>selectSocialPhoto($('socialCameraFile').files[0]);
$('socialGalleryFile').onchange=()=>selectSocialPhoto($('socialGalleryFile').files[0]);
